...
document.addEventListener('DOMContentLoaded', () => {
  const start = async() => {
    ...
    const mindarThree = new window.MINDAR.IMAGE.MindARThree({
      ...
      imageTargetSrc: './target/card.mind',
    });
    ...
    const [
      ...
      './imgs/left.png',
      './imgs/right.png',
      './imgs/paintandquest-preview.png',
      './imgs/coffeemachine-preview.png',
      './imgs/peak-preview.png',
    ]);
    ...
    const portfolioItem0Video = await loadVideo("./videos/paintandquest.mp4");
    ...
    const avatar = await loadGLTF('./gltf/scene.gltf');
    ...
    document.body.addEventListener('pointerdown' /* 'click' */, (e) => {
              ...
              portfolioItem0Video.play();
                  ...
                  if (portfolioItem0Video.paused) {
                    ...
                    portfolioItem0Video.pause();
                      ...
                      textElement.innerHTML = "https://github.com/shakmatton";

                    } else if (o === emailIcon) {
                        textObj.visible = true;
                        textElement.innerHTML = "iuri.cordeiro@unioeste.br";

                      } else if (o === profileIcon) {
                          textObj.visible = true;
                          textElement.innerHTML = "Iuri Cordeiro - Graduando em Ciência da Computação - Unioeste 2024";
                          
                        } else if (o === locationIcon) {
                        textObj.visible = true;
                        textElement.innerHTML = "Foz do Iguaçu, Brasil";
                }
          }
      }
    });
